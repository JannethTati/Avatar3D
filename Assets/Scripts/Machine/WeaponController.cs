...
namespace Deforestation.Machine.Weapon
{
    ...
    public class WeaponController : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            // Corrección del error CS0019: Se asegura que `UseResource` devuelva un valor booleano.
            if (Input.GetMouseButtonDown(0) && GameController.Instance.MachineModeOn && GameController.Instance.Inventory.HasResource(Recolectables.RecolectableType.SuperCrystal))
            {
                GameController.Instance.Inventory.UseResource(Recolectables.RecolectableType.SuperCrystal);
                Shoot(hit.point);
            }
        }
