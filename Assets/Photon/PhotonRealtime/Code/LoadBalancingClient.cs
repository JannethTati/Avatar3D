...
namespace Photon.Realtime
{
    ...
    // The issue arises because the `IConnectionCallbacks` interface has two identical method signatures for `OnJoinedRoom()`.
    // This ambiguity can be resolved by removing the duplicate method declaration in the `IConnectionCallbacks` interface.
    ...
    public interface IConnectionCallbacks
    {
        ...
        void OnJoinedRoom(); // Retain only one declaration of OnJoinedRoom()
    }
